    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(db_column='user_id', max_length=10, primary_key=True, serialize=False)),
                ('role_type', models.CharField(choices=[('Super_Admin', 'Super Admin'), ('Clinic_Admin', 'Clinic Admin'), ('Doctor', 'Doctor'), ('Pharmacist', 'Pharmacist')], max_length=20)),
                ('failed_login_attempts', models.IntegerField(default=0)),
                ('clinic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='clinical.clinic')),
